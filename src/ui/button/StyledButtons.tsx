...
export const PrimaryButton = (props: TouchableProps & TouchableType & { text: string }) => {
  const theme = useTheme();
  const { variant, text } = props;

  return (
    <>
      <Touchable color="primary" />
      <Text
...
export const DangerButton = (props: TouchableProps & TouchableType  & { text: string }) => {
  const theme = useTheme();
  const { variant, text } = props;
